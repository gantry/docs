...
{{ gravui_callout(page.media['multilanguage_1.png'].url, callout_items, 'shadow border') }}
...
{{ gravui_callout(page.media['multilanguage_2.png'].url, callout_items, 'shadow border') }}
...
{{ gravui_callout(page.media['multilanguage_3.png'].url, callout_items, 'shadow border') }}
